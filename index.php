                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="top_right text-right">
                            <ul>
                                <li class="top_links"><a href="#"><?php if (isset($_SESSION['user'])) {
                                        echo $_SESSION['user'];
                                    } else {
                                        echo 'My Account';
                        ...
                        <div class="col-lg-4">
                            <div class="search_bar">
                                <form action="" method="get">
                                    <input placeholder="Search entire store here..." type="text" name="txtsearch">
                            ...
                            <div class="row product_column4">
                                <?php
                                    if (isset($_REQUEST['Loai'])) {
                                        $p->xuatdssanphambyLoai($_REQUEST['Loai']);
                                    } elseif (isset($_REQUEST['Search'])) {
                                        $p->vSelectSPByName($_REQUEST['txtsearch']);
                                    } else {
                                        $p->xuatdssanpham();
                                    }

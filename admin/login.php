        ...
        <div class="container h-100">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto h-100">
              ...
              <li class="nav-item">
                <a class="nav-link" href="view/accounts.php">
              ...
              <div class="col-12">
                <form action="" method="post" class="tm-login-form">
                  ...
                  <div class="form-group mt-4">
                    <button
                      type="submit" name="btnDN" class="btn btn-primary btn-block text-uppercase">Login
                    </button>
                  </div>
                </form>
                <?php
                  if(isset($_REQUEST['btnDN'])){
                    ...
                    $p = new cNguoiDung();
                    $kq = $p->get01user($_REQUEST['txttk'], $_REQUEST['txtmk']);
                    }
                ?>
              </div>
            </div>

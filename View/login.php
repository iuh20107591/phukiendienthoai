                ...
                <div class="col-lg-6 col-md-6">
                    <div class="account_form register">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="login_submit">
                                <button type="submit" name="btnDK" value="dangky">Register</button>
                            </div>
                            <?php
                            if (isset($_REQUEST['btnDK'])) {
                                include_once ('Controller/cNguoiDung.php');
                                $pdk = new controlNguoiDung();
                                if ($_REQUEST['txtdk'] != '' && $_REQUEST['txtmk'] != '') {
                                    $kq2 = $pdk->themNguoiDung($_REQUEST['txtdk'], $_REQUEST['txtmk']);
                                }
                            }
                            ?>
                        </form>
